!function(e, t) {
    ...
    var s, l = "FirebaseError", c = (function(e, t) {
        ...
        return e(this, void 0, void 0, function() {
            ...
            return i(this, function(e) {
                ...
                case 0:
                    ...
                    [4, Promise.all(a(a([], f(t.filter(function(e) {
    ...
    C.prototype.initialize = function(e) {
        var t, n, r = (e = void 0 === e ? {} : e).instanceIdentifier, e = e.options, e = void 0 === e ? {} : e, i = this.normalizeInstanceIdentifier(void 0 === r ? _ : r);
    ...
    var H = ((H = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",
    ...
    H["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.",
    ...
    $.prototype._getService = function(e, t) {
        ...
        return n.isInitialized() || "EXPLICIT" !== (null === (e = n.getComponent()) || void 0 === e ? void 0 : e.instantiationMode) || n.initialize(),
        n.getImmediate({
            identifier: t
        })
    }
    ...
    function $(e, t, n) {
        ...
        this._addComponent(new E("app",function() {
            return r
        }
        ,"PUBLIC")),
    ...
    function J(a) {
        var s = {}
          ...
          , c = {
            ...
            registerVersion: function(e, t, n) {
                ...
                var i = r.match(/\s|\//)
                  , e = t.match(/\s|\//);
                i || e ? (n = ['Unable to register library "' + r + '" with version "' + t + '":'],
                ...
                W.warn(n.join(" "))) : o(new E(r + "-version",function() {
                    return {
                        library: r,
                        version: t
                    }
        ...
        function o(n) {
            var e, r = n.name;
            if (l.has(r))
                return W.debug("There were multiple attempts to register component " + r + "."),
    ...
    return ee.registerVersion("firebase", "8.6.3", "app"),
    ee
});